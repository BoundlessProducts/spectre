// Benchmark spec: k=20 invariants (for monitor overhead scaling measurement)
...
invariant inv11 { aliceBalance <= 3000000 }
invariant inv12 { bobBalance <= 3000000 }
invariant inv13 { aliceBalance + bobBalance <= 3000000 }
invariant inv14 { aliceBalance >= -2 }
invariant inv15 { bobBalance >= -2 }
invariant inv16 { aliceBalance <= 4000000 }
invariant inv17 { bobBalance <= 4000000 }
invariant inv18 { aliceBalance + bobBalance <= 4000000 }
invariant inv19 { aliceBalance >= -3 }
invariant inv20 { bobBalance >= -3 }
