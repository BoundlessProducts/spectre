// Raft Leader Election + Log Replication Safety — 7-node cluster
...
var term1:      int
description "Node that node 1 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for1: int
...
var term2:      int
description "Node that node 2 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for2: int
...
var term3:      int
description "Node that node 3 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for3: int
...
var term4:      int
description "Node that node 4 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for4: int
...
var term5:      int
description "Node that node 5 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for5: int
...
description "Role of node 6"
var state6:     NodeState
description "Current Raft term for node 6 (bounded 0-3)"
var term6:      int
description "Node that node 6 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for6: int
description "Votes collected by node 6 as Candidate"
var votes6:     int
description "Log length of node 6 (bounded 0-3)"
var log_len6:   int

description "Role of node 7"
var state7:     NodeState
description "Current Raft term for node 7 (bounded 0-3)"
var term7:      int
description "Node that node 7 voted for this term (0 = no vote, 1-7 = node ID)"
var voted_for7: int
description "Votes collected by node 7 as Candidate"
var votes7:     int
description "Log length of node 7 (bounded 0-3)"
var log_len7:   int

init {
  state1 = NodeState.Follower  state2 = NodeState.Follower  state3 = NodeState.Follower  state4 = NodeState.Follower  state5 = NodeState.Follower  state6 = NodeState.Follower  state7 = NodeState.Follower
  term1 = 0  term2 = 0  term3 = 0  term4 = 0  term5 = 0  term6 = 0  term7 = 0
  voted_for1 = 0  voted_for2 = 0  voted_for3 = 0  voted_for4 = 0  voted_for5 = 0  voted_for6 = 0  voted_for7 = 0
  votes1 = 0  votes2 = 0  votes3 = 0  votes4 = 0  votes5 = 0  votes6 = 0  votes7 = 0
  log_len1 = 0  log_len2 = 0  log_len3 = 0  log_len4 = 0  log_len5 = 0  log_len6 = 0  log_len7 = 0
}
...
description "Node 6 starts a new election: bumps term, becomes Candidate, self-votes"
action startElection6 {
  require state6 != NodeState.Leader
  require term6 < 3
  state6'     = NodeState.Candidate
  term6'      = term6 + 1
  voted_for6' = 0
  votes6'     = 1
}

description "Node 7 starts a new election: bumps term, becomes Candidate, self-votes"
action startElection7 {
  require state7 != NodeState.Leader
  require term7 < 3
  state7'     = NodeState.Candidate
  term7'      = term7 + 1
  voted_for7' = 0
  votes7'     = 1
}
...
description "Node 6 (Follower) grants its vote to Candidate node 1"
action vote6for1 {
  require state1 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes1 < 7
  require term1 > term6 || (term1 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 1
  voted_for6' = 1
  term6'      = term1
  votes1'     = votes1 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 1"
action vote7for1 {
  require state1 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes1 < 7
  require term1 > term7 || (term1 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 1
  voted_for7' = 1
  term7'      = term1
  votes1'     = votes1 + 1
}
...
description "Node 6 (Follower) grants its vote to Candidate node 2"
action vote6for2 {
  require state2 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes2 < 7
  require term2 > term6 || (term2 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 2
  voted_for6' = 2
  term6'      = term2
  votes2'     = votes2 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 2"
action vote7for2 {
  require state2 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes2 < 7
  require term2 > term7 || (term2 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 2
  voted_for7' = 2
  term7'      = term2
  votes2'     = votes2 + 1
}
...
description "Node 6 (Follower) grants its vote to Candidate node 3"
action vote6for3 {
  require state3 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes3 < 7
  require term3 > term6 || (term3 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 3
  voted_for6' = 3
  term6'      = term3
  votes3'     = votes3 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 3"
action vote7for3 {
  require state3 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes3 < 7
  require term3 > term7 || (term3 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 3
  voted_for7' = 3
  term7'      = term3
  votes3'     = votes3 + 1
}
...
description "Node 6 (Follower) grants its vote to Candidate node 4"
action vote6for4 {
  require state4 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes4 < 7
  require term4 > term6 || (term4 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 4
  voted_for6' = 4
  term6'      = term4
  votes4'     = votes4 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 4"
action vote7for4 {
  require state4 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes4 < 7
  require term4 > term7 || (term4 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 4
  voted_for7' = 4
  term7'      = term4
  votes4'     = votes4 + 1
}
...
description "Node 6 (Follower) grants its vote to Candidate node 5"
action vote6for5 {
  require state5 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes5 < 7
  require term5 > term6 || (term5 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 5
  voted_for6' = 5
  term6'      = term5
  votes5'     = votes5 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 5"
action vote7for5 {
  require state5 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes5 < 7
  require term5 > term7 || (term5 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 5
  voted_for7' = 5
  term7'      = term5
  votes5'     = votes5 + 1
}

description "Node 1 (Follower) grants its vote to Candidate node 6"
action vote1for6 {
  require state6 == NodeState.Candidate
  require state1 == NodeState.Follower
  require votes6 < 7
  require term6 > term1 || (term6 == term1 && voted_for1 == 0)
  require voted_for1 == 0 || voted_for1 == 6
  voted_for1' = 6
  term1'      = term6
  votes6'     = votes6 + 1
}

description "Node 2 (Follower) grants its vote to Candidate node 6"
action vote2for6 {
  require state6 == NodeState.Candidate
  require state2 == NodeState.Follower
  require votes6 < 7
  require term6 > term2 || (term6 == term2 && voted_for2 == 0)
  require voted_for2 == 0 || voted_for2 == 6
  voted_for2' = 6
  term2'      = term6
  votes6'     = votes6 + 1
}

description "Node 3 (Follower) grants its vote to Candidate node 6"
action vote3for6 {
  require state6 == NodeState.Candidate
  require state3 == NodeState.Follower
  require votes6 < 7
  require term6 > term3 || (term6 == term3 && voted_for3 == 0)
  require voted_for3 == 0 || voted_for3 == 6
  voted_for3' = 6
  term3'      = term6
  votes6'     = votes6 + 1
}

description "Node 4 (Follower) grants its vote to Candidate node 6"
action vote4for6 {
  require state6 == NodeState.Candidate
  require state4 == NodeState.Follower
  require votes6 < 7
  require term6 > term4 || (term6 == term4 && voted_for4 == 0)
  require voted_for4 == 0 || voted_for4 == 6
  voted_for4' = 6
  term4'      = term6
  votes6'     = votes6 + 1
}

description "Node 5 (Follower) grants its vote to Candidate node 6"
action vote5for6 {
  require state6 == NodeState.Candidate
  require state5 == NodeState.Follower
  require votes6 < 7
  require term6 > term5 || (term6 == term5 && voted_for5 == 0)
  require voted_for5 == 0 || voted_for5 == 6
  voted_for5' = 6
  term5'      = term6
  votes6'     = votes6 + 1
}

description "Node 7 (Follower) grants its vote to Candidate node 6"
action vote7for6 {
  require state6 == NodeState.Candidate
  require state7 == NodeState.Follower
  require votes6 < 7
  require term6 > term7 || (term6 == term7 && voted_for7 == 0)
  require voted_for7 == 0 || voted_for7 == 6
  voted_for7' = 6
  term7'      = term6
  votes6'     = votes6 + 1
}

description "Node 1 (Follower) grants its vote to Candidate node 7"
action vote1for7 {
  require state7 == NodeState.Candidate
  require state1 == NodeState.Follower
  require votes7 < 7
  require term7 > term1 || (term7 == term1 && voted_for1 == 0)
  require voted_for1 == 0 || voted_for1 == 7
  voted_for1' = 7
  term1'      = term7
  votes7'     = votes7 + 1
}

description "Node 2 (Follower) grants its vote to Candidate node 7"
action vote2for7 {
  require state7 == NodeState.Candidate
  require state2 == NodeState.Follower
  require votes7 < 7
  require term7 > term2 || (term7 == term2 && voted_for2 == 0)
  require voted_for2 == 0 || voted_for2 == 7
  voted_for2' = 7
  term2'      = term7
  votes7'     = votes7 + 1
}

description "Node 3 (Follower) grants its vote to Candidate node 7"
action vote3for7 {
  require state7 == NodeState.Candidate
  require state3 == NodeState.Follower
  require votes7 < 7
  require term7 > term3 || (term7 == term3 && voted_for3 == 0)
  require voted_for3 == 0 || voted_for3 == 7
  voted_for3' = 7
  term3'      = term7
  votes7'     = votes7 + 1
}

description "Node 4 (Follower) grants its vote to Candidate node 7"
action vote4for7 {
  require state7 == NodeState.Candidate
  require state4 == NodeState.Follower
  require votes7 < 7
  require term7 > term4 || (term7 == term4 && voted_for4 == 0)
  require voted_for4 == 0 || voted_for4 == 7
  voted_for4' = 7
  term4'      = term7
  votes7'     = votes7 + 1
}

description "Node 5 (Follower) grants its vote to Candidate node 7"
action vote5for7 {
  require state7 == NodeState.Candidate
  require state5 == NodeState.Follower
  require votes7 < 7
  require term7 > term5 || (term7 == term5 && voted_for5 == 0)
  require voted_for5 == 0 || voted_for5 == 7
  voted_for5' = 7
  term5'      = term7
  votes7'     = votes7 + 1
}

description "Node 6 (Follower) grants its vote to Candidate node 7"
action vote6for7 {
  require state7 == NodeState.Candidate
  require state6 == NodeState.Follower
  require votes7 < 7
  require term7 > term6 || (term7 == term6 && voted_for6 == 0)
  require voted_for6 == 0 || voted_for6 == 7
  voted_for6' = 7
  term6'      = term7
  votes7'     = votes7 + 1
}
...
description "Node 6 becomes Leader once it holds a strict majority"
action becomeLeader6 {
  require state6 == NodeState.Candidate
  require votes6 * 2 > 7
  state6' = NodeState.Leader
}

description "Node 7 becomes Leader once it holds a strict majority"
action becomeLeader7 {
  require state7 == NodeState.Candidate
  require votes7 * 2 > 7
  state7' = NodeState.Leader
}
...
description "Leader node 6 appends one new log entry"
action appendEntry6 {
  require state6 == NodeState.Leader
  require log_len6 < 3
  log_len6' = log_len6 + 1
...
description "Leader node 7 appends one new log entry"
action appendEntry7 {
  require state7 == NodeState.Leader
  require log_len7 < 3
  log_len7' = log_len7 + 1
...
description "Leader node 1 replicates one entry to Follower node 6"
action replicate1to6 {
  require state1 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term1
  require log_len6 < log_len1
  log_len6' = log_len6 + 1
}

description "Leader node 1 replicates one entry to Follower node 7"
action replicate1to7 {
  require state1 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term1
  require log_len7 < log_len1
  log_len7' = log_len7 + 1
}
...
description "Leader node 2 replicates one entry to Follower node 6"
action replicate2to6 {
  require state2 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term2
  require log_len6 < log_len2
  log_len6' = log_len6 + 1
}

description "Leader node 2 replicates one entry to Follower node 7"
action replicate2to7 {
  require state2 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term2
  require log_len7 < log_len2
  log_len7' = log_len7 + 1
}
...
description "Leader node 3 replicates one entry to Follower node 6"
action replicate3to6 {
  require state3 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term3
  require log_len6 < log_len3
  log_len6' = log_len6 + 1
}

description "Leader node 3 replicates one entry to Follower node 7"
action replicate3to7 {
  require state3 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term3
  require log_len7 < log_len3
  log_len7' = log_len7 + 1
}
...
description "Leader node 4 replicates one entry to Follower node 6"
action replicate4to6 {
  require state4 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term4
  require log_len6 < log_len4
  log_len6' = log_len6 + 1
}

description "Leader node 4 replicates one entry to Follower node 7"
action replicate4to7 {
  require state4 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term4
  require log_len7 < log_len4
  log_len7' = log_len7 + 1
}
...
description "Leader node 5 replicates one entry to Follower node 6"
action replicate5to6 {
  require state5 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term5
  require log_len6 < log_len5
  log_len6' = log_len6 + 1
}

description "Leader node 5 replicates one entry to Follower node 7"
action replicate5to7 {
  require state5 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term5
  require log_len7 < log_len5
  log_len7' = log_len7 + 1
}

description "Leader node 6 replicates one entry to Follower node 1"
action replicate6to1 {
  require state6 == NodeState.Leader
  require state1 == NodeState.Follower
  require term1 == term6
  require log_len1 < log_len6
  log_len1' = log_len1 + 1
}

description "Leader node 6 replicates one entry to Follower node 2"
action replicate6to2 {
  require state6 == NodeState.Leader
  require state2 == NodeState.Follower
  require term2 == term6
  require log_len2 < log_len6
  log_len2' = log_len2 + 1
}

description "Leader node 6 replicates one entry to Follower node 3"
action replicate6to3 {
  require state6 == NodeState.Leader
  require state3 == NodeState.Follower
  require term3 == term6
  require log_len3 < log_len6
  log_len3' = log_len3 + 1
}

description "Leader node 6 replicates one entry to Follower node 4"
action replicate6to4 {
  require state6 == NodeState.Leader
  require state4 == NodeState.Follower
  require term4 == term6
  require log_len4 < log_len6
  log_len4' = log_len4 + 1
}

description "Leader node 6 replicates one entry to Follower node 5"
action replicate6to5 {
  require state6 == NodeState.Leader
  require state5 == NodeState.Follower
  require term5 == term6
  require log_len5 < log_len6
  log_len5' = log_len5 + 1
}

description "Leader node 6 replicates one entry to Follower node 7"
action replicate6to7 {
  require state6 == NodeState.Leader
  require state7 == NodeState.Follower
  require term7 == term6
  require log_len7 < log_len6
  log_len7' = log_len7 + 1
}

description "Leader node 7 replicates one entry to Follower node 1"
action replicate7to1 {
  require state7 == NodeState.Leader
  require state1 == NodeState.Follower
  require term1 == term7
  require log_len1 < log_len7
  log_len1' = log_len1 + 1
}

description "Leader node 7 replicates one entry to Follower node 2"
action replicate7to2 {
  require state7 == NodeState.Leader
  require state2 == NodeState.Follower
  require term2 == term7
  require log_len2 < log_len7
  log_len2' = log_len2 + 1
}

description "Leader node 7 replicates one entry to Follower node 3"
action replicate7to3 {
  require state7 == NodeState.Leader
  require state3 == NodeState.Follower
  require term3 == term7
  require log_len3 < log_len7
  log_len3' = log_len3 + 1
}

description "Leader node 7 replicates one entry to Follower node 4"
action replicate7to4 {
  require state7 == NodeState.Leader
  require state4 == NodeState.Follower
  require term4 == term7
  require log_len4 < log_len7
  log_len4' = log_len4 + 1
}

description "Leader node 7 replicates one entry to Follower node 5"
action replicate7to5 {
  require state7 == NodeState.Leader
  require state5 == NodeState.Follower
  require term5 == term7
  require log_len5 < log_len7
  log_len5' = log_len5 + 1
}

description "Leader node 7 replicates one entry to Follower node 6"
action replicate7to6 {
  require state7 == NodeState.Leader
  require state6 == NodeState.Follower
  require term6 == term7
  require log_len6 < log_len7
  log_len6' = log_len6 + 1
}
...
description "Node 1 steps down upon observing node 6 in a higher term"
action stepDown1_sees6 {
  require state1 != NodeState.Follower
  require term6 > term1
  state1'     = NodeState.Follower
  term1'      = term6
...
description "Node 1 steps down upon observing node 7 in a higher term"
action stepDown1_sees7 {
  require state1 != NodeState.Follower
  require term7 > term1
  state1'     = NodeState.Follower
  term1'      = term7
...
description "Node 2 steps down upon observing node 6 in a higher term"
action stepDown2_sees6 {
  require state2 != NodeState.Follower
  require term6 > term2
  state2'     = NodeState.Follower
  term2'      = term6
...
description "Node 2 steps down upon observing node 7 in a higher term"
action stepDown2_sees7 {
  require state2 != NodeState.Follower
  require term7 > term2
  state2'     = NodeState.Follower
  term2'      = term7
...
description "Node 3 steps down upon observing node 6 in a higher term"
action stepDown3_sees6 {
  require state3 != NodeState.Follower
  require term6 > term3
  state3'     = NodeState.Follower
  term3'      = term6
...
description "Node 3 steps down upon observing node 7 in a higher term"
action stepDown3_sees7 {
  require state3 != NodeState.Follower
  require term7 > term3
  state3'     = NodeState.Follower
  term3'      = term7
...
description "Node 4 steps down upon observing node 6 in a higher term"
action stepDown4_sees6 {
  require state4 != NodeState.Follower
  require term6 > term4
  state4'     = NodeState.Follower
  term4'      = term6
...
description "Node 4 steps down upon observing node 7 in a higher term"
action stepDown4_sees7 {
  require state4 != NodeState.Follower
  require term7 > term4
  state4'     = NodeState.Follower
  term4'      = term7
...
description "Node 5 steps down upon observing node 6 in a higher term"
action stepDown5_sees6 {
  require state5 != NodeState.Follower
  require term6 > term5
  state5'     = NodeState.Follower
  term5'      = term6
...
description "Node 5 steps down upon observing node 7 in a higher term"
action stepDown5_sees7 {
  require state5 != NodeState.Follower
  require term7 > term5
  state5'     = NodeState.Follower
  term5'      = term7
...
description "Node 6 steps down upon observing node 1 in a higher term"
action stepDown6_sees1 {
  require state6 != NodeState.Follower
  require term1 > term6
  state6'     = NodeState.Follower
  term6'      = term1
  voted_for6' = 0
  votes6'     = 0
}

description "Node 6 steps down upon observing node 2 in a higher term"
action stepDown6_sees2 {
  require state6 != NodeState.Follower
  require term2 > term6
  state6'     = NodeState.Follower
  term6'      = term2
...
description "Node 6 steps down upon observing node 3 in a higher term"
action stepDown6_sees3 {
  require state6 != NodeState.Follower
  require term3 > term6
  state6'     = NodeState.Follower
  term6'      = term3
...
description "Node 6 steps down upon observing node 4 in a higher term"
action stepDown6_sees4 {
  require state6 != NodeState.Follower
  require term4 > term6
  state6'     = NodeState.Follower
  term6'      = term4
...
description "Node 6 steps down upon observing node 5 in a higher term"
action stepDown6_sees5 {
  require state6 != NodeState.Follower
  require term5 > term6
  state6'     = NodeState.Follower
  term6'      = term5
...
description "Node 6 steps down upon observing node 7 in a higher term"
action stepDown6_sees7 {
  require state6 != NodeState.Follower
  require term7 > term6
  state6'     = NodeState.Follower
  term6'      = term7
...
description "Node 7 steps down upon observing node 1 in a higher term"
action stepDown7_sees1 {
  require state7 != NodeState.Follower
  require term1 > term7
  state7'     = NodeState.Follower
  term7'      = term1
  voted_for7' = 0
  votes7'     = 0
}

description "Node 7 steps down upon observing node 2 in a higher term"
action stepDown7_sees2 {
  require state7 != NodeState.Follower
  require term2 > term7
  state7'     = NodeState.Follower
  term7'      = term2
...
description "Node 7 steps down upon observing node 3 in a higher term"
action stepDown7_sees3 {
  require state7 != NodeState.Follower
  require term3 > term7
  state7'     = NodeState.Follower
  term7'      = term3
...
description "Node 7 steps down upon observing node 4 in a higher term"
action stepDown7_sees4 {
  require state7 != NodeState.Follower
  require term4 > term7
  state7'     = NodeState.Follower
  term7'      = term4
...
description "Node 7 steps down upon observing node 5 in a higher term"
action stepDown7_sees5 {
  require state7 != NodeState.Follower
  require term5 > term7
  state7'     = NodeState.Follower
  term7'      = term5
...
description "Node 7 steps down upon observing node 6 in a higher term"
action stepDown7_sees6 {
  require state7 != NodeState.Follower
  require term6 > term7
  state7'     = NodeState.Follower
  term7'      = term6
...
invariant electionSafety {
  ...
  !(state1 == NodeState.Leader && state6 == NodeState.Leader && term1 == term6) &&
  !(state1 == NodeState.Leader && state7 == NodeState.Leader && term1 == term7) &&
  ...
  !(state2 == NodeState.Leader && state6 == NodeState.Leader && term2 == term6) &&
  !(state2 == NodeState.Leader && state7 == NodeState.Leader && term2 == term7) &&
  !(state3 == NodeState.Leader && state4 == NodeState.Leader && term3 == term4) &&
  !(state3 == NodeState.Leader && state5 == NodeState.Leader && term3 == term5) &&
  !(state3 == NodeState.Leader && state6 == NodeState.Leader && term3 == term6) &&
  !(state3 == NodeState.Leader && state7 == NodeState.Leader && term3 == term7) &&
  !(state4 == NodeState.Leader && state5 == NodeState.Leader && term4 == term5) &&
  !(state4 == NodeState.Leader && state6 == NodeState.Leader && term4 == term6) &&
  !(state4 == NodeState.Leader && state7 == NodeState.Leader && term4 == term7) &&
  !(state5 == NodeState.Leader && state6 == NodeState.Leader && term5 == term6) &&
  !(state5 == NodeState.Leader && state7 == NodeState.Leader && term5 == term7) &&
  !(state6 == NodeState.Leader && state7 == NodeState.Leader && term6 == term7)
}

description "Leader legitimacy: every Leader holds a strict majority of votes"
invariant leaderMajority {
  (!(state1 == NodeState.Leader) || votes1 * 2 > 7) &&
  (!(state2 == NodeState.Leader) || votes2 * 2 > 7) &&
  (!(state3 == NodeState.Leader) || votes3 * 2 > 7) &&
  (!(state4 == NodeState.Leader) || votes4 * 2 > 7) &&
  (!(state5 == NodeState.Leader) || votes5 * 2 > 7) &&
  (!(state6 == NodeState.Leader) || votes6 * 2 > 7) &&
  (!(state7 == NodeState.Leader) || votes7 * 2 > 7)
}
...
invariant candidateSelfVote {
  ...
  (!(state6 == NodeState.Candidate) || votes6 >= 1) &&
  (!(state7 == NodeState.Candidate) || votes7 >= 1)
}
